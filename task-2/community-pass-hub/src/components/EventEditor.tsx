...
export function EventEditor({ event }: { event?: EventRow }) {
  ...
  const save = async (status: "draft" | "published") => {
    ...
    if (!form.venue_address.trim() && !form.online_link.trim()) {
      toast.error("Provide a venue address or an online link");
      return;
    }
    setSaving(true);
    const payload = {
    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <Label htmlFor="v">Venue address</Label>
            <Input
              id="v"
          ...
          <div>
            <Label htmlFor="o">Online link</Label>
            <Input
              id="o"
        ...
        <div className="flex flex-wrap items-center gap-6 rounded-md border border-border p-4">
          <div className="flex items-center gap-2">
            <Switch
              ...
              onCheckedChange={(v) => set("visibility", v ? "public" : "unlisted")}
            />
            ...
            <Button
              ...
              onClick={async () => {
                ...
                if (error) toast.error(error.message);
                  ...
                  navigate({ to: "/host/events/$eventId/edit", params: { eventId: data!.id } });
                }
              }}
            >
